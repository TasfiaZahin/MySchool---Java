 ...
 * @author User
 */
public class UNIVERSITY_READController implements Initializable {
    @FXML
    Button button_buet;
    @FXML
    Button button_mit;
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        ...
        {
            MySchool.window.setScene(MySchool.MIT_READ);
        }
        else if(event.getSource()==button_oxford)
        {
            MySchool.window.setScene(MySchool.OXFORD_READ);
        }
    }
}
